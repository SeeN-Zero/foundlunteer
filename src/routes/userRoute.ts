...
router.get('/getimage', authentication, getUserImageController as RequestHandler)
...
router.get('/getcv', authentication, getUserCvController as RequestHandler)
router.get('/getcv/:userId', authentication, getUserCvController as RequestHandler)
router.get('/getijazah', authentication, getUserIjazahController as RequestHandler)
router.get('/getijazah/:userId', authentication, getUserIjazahController as RequestHandler)
router.get('/getsertifikat', authentication, getUserSertifikatController as RequestHandler)
